...
#rsync = "rsync -v -rlt -z --chmod=a=rw,Da+x --delete"
rsync = "rsync -avn -z" # a = rltpgoD
...
logfile = logprefix + logfiledate + "_log.txt"
	...
	while queue.empty != True:
		...
		if dir in exclude:
			...
			ret = subprocess.call(command,
								shell=True,
								stdout=open(dirprefix + dir + logfiledate + '-log.txt', 'a'),
